    ...
    <div className="max-w-4xl mx-auto">
      ...
      <div className="grid md:grid-cols-2 gap-12">
        <div className="space-y-6">
          <div>
            <h3 className="text-[#40F8D2] mb-4">[첫인상을 주는 프론트엔드]</h3>
            <p className="text-sm leading-relaxed">
              학생 시절 React, Next.js, Vue.js 를 활용한 웹 개발 경험이 있으며,
              사용자에게 먼저 보여지는 프론트엔드에 흥미를 느꼈고 React,
              Next.js, Vue.js 를 활용한 프론트엔드 개발을 주로 진행하고
              있습니다.
            </p>
          </div>
          <div>
          ...
          <div>
            ...
            <p className="text-sm leading-relaxed">
              ...
              과정에서 다양한 문제를 함께 해결해 나가며, 때론 기능 구현에 며칠이
              걸리기도 했습니다. 하지만 이런 과정을 통해 &quot;해결할 수 없는
              문제는 없다&quot;는 확신을 가지게 되었습니다.
            </p>
          </div>
        </div>
