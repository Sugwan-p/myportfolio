        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          <div className="lg:col-span-1 space-y-6">
            {contactInfo.map((info, index) => (
              ...
              >
                <div className="p-3 bg-[#ff6b45]/10 text-[#ff6b45] rounded-full mr-4">{info.icon}</div>
                <div>
          ...
          <div className="lg:col-span-2 bg-white p-8 rounded-lg shadow-sm">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div>
                <Input name="subject" placeholder="제목" value={formData.subject} onChange={handleChange} required />
              </div>
              <div>
                <Textarea
                  name="message"
              ...
              <Button type="submit" className="bg-[#ff6b45] hover:bg-[#ff6b45]/90">
