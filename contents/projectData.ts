...
export const subProjects = [
  ...
  {
    title: 'UNO 보드게임',
    description: 'UNO 보드게임 사이트',
    tags: ['next.js', 'tailwindCSS', 'typescript', 'Firebase'],
    link: 'https://github.com/Sugwan-p/UNO',
  },
  {
    title: 'Google Chrome Extension (Private)',
    description:
      '기업 내부 프로젝트로 개발한 뉴스 분석 Chrome 확장 프로그램입니다. ' +
      '계약상 전체 소스코드는 공개할 수 없으나, ' +
      '뉴스 콘텐츠를 분석하여 요약·분류하는 기능을 구현했습니다.',
    tags: [
      'React',
      'TypeScript',
      'Tailwind CSS',
    ...
    link: 'https://efficient-knot-8e2.notion.site/Google-extension-2d7931125dd6803caa5fc2eed8cd2af1',
  },
];
